	...
	public ScheduleHourRestrictionCSP(List<PersonAvalability> employeers, Integer minHour, Integer maxHour) throws ScheduleHourRestrictionException {
		...
		for (int i = 0; i < size; i++) {
			...
			try {
				...
				//Aqui é verificado se o funcionario consegue cumprir sua carga horaria com a nova lista de disponibilidade
				...
				throw new ScheduleHourRestrictionException("Com a aplicação de restrições de horario, o empregado "+name+
