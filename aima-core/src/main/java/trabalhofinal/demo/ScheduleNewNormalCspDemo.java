...
//Resolução problema agendamento novo normal
public class ScheduleNewNormalCspDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			PersonAvalability alice = new PersonAvalability("Alice", list1, 2, false);
			PersonAvalability bob = new PersonAvalability("Bob", list2, 3, true);
			PersonAvalability charlie = new PersonAvalability("Charlie", list3, 1, true);
			PersonAvalability david = new PersonAvalability("David", list4, 2, true);
			PersonAvalability eve = new PersonAvalability("Eve", list5, 4, false);
			
			//Lista de funcionarios
			List<PersonAvalability> employeers = new ArrayList<PersonAvalability>(
					Arrays.asList(david, bob, charlie, alice, eve));
			
			System.out.println("PROBLEMA NOVO NORMAL\n");
