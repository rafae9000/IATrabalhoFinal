...
import trabalhofinal.csp.SchedulePriotityWorkCSP;
...
//Resolução problema agendamento com prioridade de trabalho
public class SchedulePriotityWorkCspDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//Atribuir uma lista de nome dos funcionarios que tem prioridade em relação ao objeto
			//Neste caso Alice e Eve tem prioridade em relação à Bob
			bob.setPriorityPersons(Arrays.asList("Alice","Eve"));
