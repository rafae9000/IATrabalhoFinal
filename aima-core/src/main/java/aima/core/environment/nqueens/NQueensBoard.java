...
public class NQueensBoard {
	...
	public enum Config {
		EMPTY, QUEENS_IN_FIRST_ROW, QUEEN_IN_EVERY_COL, TESTE1
	}
	...
	public NQueensBoard(int size, Config config) {
		...
		} else if (config == Config.TESTE1) {
			System.out.println("adicionando rainha!!!");
			addQueenAt(new XYLocation(0,0));
			System.out.println("rainha adicionada!!!");
		}
	}
